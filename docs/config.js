...
window.NSM_SUNDAY_CONFIG = {
  SEASON: "2026",
  SITE_URL: "https://nssm-rugby.vercel.app",
  SITE: {
    ...
    "Wakehurst Rugby Park": {
      ...
      "details": {
        "map": {
          ...
          "caption": "Pitch layout — TT1 (south-west), TT2 (north-west), TT3 (north-east), TT4 (south-east)",
          "asOf": "2026-05"
        },
        ...
        "coffee": {
          "onsite": "Canteen opens 7:30am (the club’s main fundraiser through the season) + BBQ + bar on the clubhouse deck."
        },
